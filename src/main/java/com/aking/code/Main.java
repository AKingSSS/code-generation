...
import com.aking.code.core.DataProcessor;
import com.aking.code.entity.Properties;
import com.aking.code.model.JerseyMethodInfo;
import com.aking.code.model.JerseyMethodModel;
...
import static com.aking.code.core.StringUtils.*;
...
//            generateTable();
            //指定表名
            generateTable("crm_construction_site");
        }
    }
    ...
    private static void generateController(String apiUrl){
        ...
        map1.entrySet().stream().forEach(stringListEntry -> {
            ...
            jerseyModel.setPackageName("");
            jerseyModel.setFeignClient(finalFeignClient);
            jerseyModel.setPath(stringListEntry.getKey());
            jerseyModel.setClassName(underLineToCamel(toUpperCaseFirst(stringListEntry.getKey())));
            jerseyModel.setLowerClassName(toLowerCaseFirst(jerseyModel.getClassName()));
